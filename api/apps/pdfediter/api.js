...
function getEditTemplate() {
	editTemplates.pdfHTML =  fs.readFileSync(path.join(helper.appPath, '../libs/pdfediter/web/viewer.html'), 'utf8');
	return editTemplates.pdfHTML || '';
}
...
function addRoutesForEachFileExtension(app) {
	...
	let ext = 'pdf'
		, options = supportedFileTypes[ext.toLowerCase()]
		, fileExt = '.' + ext
