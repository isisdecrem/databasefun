if (window.capturer === undefined) {
    (function() {
    	...
    	var folderPath = document.querySelector('#capture_folder_path')
    	...
    	function load(map, callback) {
            ...
            $captureForm.addEventListener('submit', function(e) {
                ...
                formData.set('folderpath', folderPath.value);
            ...
            if(map.resourcerControl) {
                ...
                $resourceButton.addEventListener('click', function(e){
                 	this.innerHTML = '<img src="/libs/icons/spinner.svg" style="width:50px">'
...
document.addEventListener('DOMContentLoaded', function() {
	$map = {
		capturerControl: document.getElementById("capture_picture"),
		resourcerControl: document.getElementById("capture_resource"),
		cameraControl: document.getElementById("capture_camera")
	}
	window.capturer.load($map)
});